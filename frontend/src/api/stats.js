...
// 查看所有缓存状态
export const getAllCacheInfo = () => api.get('/admin/cache_list');
...
// 获取存档列表
export const getArchiveList = () => api.get('/admin/archive_list');
...
// 获取赛季名称映射
export const getSeasonNameMap = () => api.get('/seasons/name_map');

// 获取比赛高光记录
export const getMatchRecords = (season = 'all') =>
 ...
 */
export const getPlayerSeasons = () => api.get('/player/seasons');
